...
### update  in 20230225
本次更新内容：wol唤醒&msi主板的诡异问题  
唤醒前提：1.主板配置，2.config.plist新增参数mausi-force-wol，3.Mac系统设置-节能开启网络唤醒  
- 微星主板配置wol参考：  
>电脑重启，在刚启动的时候反复按下键盘上的Del键或者Delete键，进入主板的BIOS设置中，点击“Advanced(高级模式)”或者按直接按下F7键。
进入高级–整合周边设备–网卡ROM启动，设置为允许。
进入高级–电源管理设置–Erp ，设置为禁止。
进入高级–唤醒事件设置–PCIE设备唤醒和网络唤醒，设置为允许。
最后，完成所有的设置之后，按下F10键保存BIOS并退出即可。  

- [新增参数mausi-force-wol](https://post.smzdm.com/p/awx4meg4/)    

注意点：    
1. oc编辑时，PCI设备列表下拉找到**有线网卡**，无线网卡可能不支持wol  
2. 微星主板的有线网卡在电脑休眠时，灯不亮是正常的    

**msi主板的诡异问题**   
电脑正常休眠的前提下，运行时间很长，比如一个月，如果手动关机，则再次开机时无反应：按开机键和重启键均无效，就像主机断电一样。但是拔掉主机插头，等十分钟左右再插上，按开机键可以正常开机。可能是电源的问题，我的电源是550W，按评论区说法要换成650W：[问题排查参考](https://www.v2ex.com/t/693726)
### update  in 20211120
